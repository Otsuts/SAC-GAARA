...
def parse_args():
    ...
    parser.add_argument('--work_dir', default='./logs', type=str)
    ...
    for i in range(num_episodes):
        ...
        while not done:
            with utils.eval_mode(agent):
                action = agent.select_action(utils.center_crop_image(obs, args.image_size))
...
def main():
    ...
    # 将python中的对象转换为json文件
    # vars函数返回对象object的属性和属性值的字典对象，如果没有参数，就打印当前调用位置的属性和属性值 类似 locals()
